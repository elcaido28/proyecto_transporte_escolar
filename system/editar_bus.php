...
$consulta="SELECT * FROM buses WHERE id_buses='$id'";
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Administrar Bus</h1>
    <ol class="breadcrumb">
      <li><a href="inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
      <li><a href="ingreso_bus.php"><i class="fa fa-list-ul"></i> Administrar Bus</a></li>
      <li class="active">Editar Bus</li>
    </ol>
  </section>
      ...
      <div class="box-header with-border">
        ...
        <div class="modal-dialog" style="border:1px solid rgb(175, 175, 175)">
          <div class="modal-content">
            ...
            <form role="form" action="modificar_bus.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
              <!--========== CABEZA DEL MODAL =================-->
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control input-lg" name="placa" value="<?php echo $row['placa']; ?>" placeholder="Ingresar Placa"  required>
                    </div>
                  </div>
                  <!-- ENTRADA -->
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control input-lg" name="marca" value="<?php echo $row['marca']; ?>" id="marca"  placeholder="Ingresar Marca" required>
                    </div>
                  </div>
                </div>
                  <!-- ENTRADA  -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control input-lg" name="modelo" value="<?php echo $row['modelo']; ?>" id="modelo" placeholder="Ingresar Modelo" required>
                    </div>
                  </div>
                  <!-- ENTRADA  -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control input-lg" name="ano" value="<?php echo $row['ano']; ?>" maxlength="4" placeholder="Ingresar Año" required>
                    </div>
                  </div>
                  </div>
                  <!-- ENTRADA  -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control input-lg" name="chasis" value="<?php echo $row['chasis']; ?>" id="chasis" placeholder="Ingresar Chasis" required>
                    </div>
                  </div>
                   <!-- ENTRADA -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control input-lg" name="motor" value="<?php echo $row['motor']; ?>" id="motor" placeholder="Ingresar Motor" required>
                    </div>
                  </div>
                  </div>
                  <!-- ENTRADA  -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="date" class="form-control input-lg" name="caduca_matricula" value="<?php echo $row['caduca_matricula']; ?>" placeholder="Ingresar Caducidad Matricula" required>
                    </div>
                  </div>
                   <!-- ENTRADA -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control input-lg" maxlength="3" name="capacidad" value="<?php echo $row['capacidad']; ?>" placeholder="Ingresar Capacidad" required>
                    </div>
                  </div>
                  </div>
                  <!-- ENTRADA  -->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="mail" class="form-control input-lg" name="descrip" value="<?php echo $row['descripcion']; ?>" placeholder="Ingresar Descripcion" required>
                    </div>
                  </div>
                   <!-- ENTRADA -->
                   <div class="form-group">
                       ...
                       <select class="form-control input-lg" name="dueno" required><option value="">Dueño Del Vehiculo</option>
                         <?php $consulta4=mysqli_query($con,"SELECT * from empleados where id_estado='1' and id_tipo_empleado='4' or id_estado='1' and id_tipo_empleado='7' ");
                           while($row4=mysqli_fetch_array($consulta4)){
                            if($row4['id_empleados']==$row['dueno']){$sel="selected='selected'";}else{$sel="";}
                      ...
                      <div class="input-group">
                        ...
                        <select class="form-control input-lg" name="conductor" required><option value="">Selecionar Conductor</option>
                          <?php $consulta4=mysqli_query($con,"SELECT * from empleados where id_estado='1' and id_tipo_empleado='6' or id_estado='1' and id_tipo_empleado='7' ");
                            while($row4=mysqli_fetch_array($consulta4)){
                                if($row4['id_empleados']==$row['conductor']){$sel="selected='selected'";}else{$sel="";}
                            echo "<option ".$sel." value='".$row4['id_empleados']."'>"; echo $row4['nombres']." ".$row4['apellidos']; echo "</option>"; } ?> </select>
                      </div>
                    </div>
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <select class="form-control input-lg" name="ayudante" required><option value="">Selecionar Ayudante</option>
                        <?php $consulta4=mysqli_query($con,"SELECT * from ayudante where id_estado='1'");
                          while($row4=mysqli_fetch_array($consulta4)){
                            if($row4['id_ayudante']==$row['id_ayudante']){$sel="selected='selected'";}else{$sel="";}
                          echo "<option ".$sel." value='".$row4['id_ayudante']."'>"; echo $row4['nombres']; echo "</option>"; } ?> </select>
                    </div>
                  </div>
                  </div>
                  <!-- ENTRADA SUBIR FOTO -->
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <select class="form-control input-lg" name="institucion" required><option value="">Selecionar Ayudante</option>
              ...
              <div class="modal-footer">
                ...
                <a href="ingreso_bus.php"><button type="button" class="btn btn-default" data-dismiss="modal">Salir</button></a>
