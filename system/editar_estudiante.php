...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="ingreso_estudiantes.php?id=<?php echo $idc; ?>"><i class="fa fa-list-ul"></i> Administrar Estudiante</a></li>
          ...
          <div class="modal-content">
            <form role="form" action="modificar_persona.php?id=<?php echo $id."&tp=".$tiperso."&idc=".$idc; ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="modal-footer">
                ...
                <a href="ingreso_estudiantes.php?id=<?php echo $idc; ?>"><button type="button" class="btn btn-default">Salir</button></a>
              </div>
            </form>
          </div>
        </div>
