...
<style media="screen">
  ...
  <section class="content-header">
    <h1>Administrar Cuota Social</h1>
    <ol class="breadcrumb">
      <li><a href="inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
      <li class="active">Cuota Social</li>
    </ol>
  </section>
  ...
  <section class="content">
    <div class="box">
      <div class="box-header with-border">
        <button class="btn btn-primary" id="agg_cuota_td" > Agregar Cuota Social </button>
      </div>
      ...
      <script type="text/javascript">
             $('#agg_cuota_td').click(function(){
                   ...
                   swalWithBootstrapButtons.fire({
                     ...
                     if (result.value) {
                         document.location.href="guardar_deuda_cuota_todos.php";
                     } else if (
      ...
      <div class="box-body cont_tabla">
       <table class="tabla" id="tabla" >
        ...
        <tbody>
          <tr>
            <?php
              $consulta=mysqli_query($con,"SELECT * from deuda_socios D inner join empleados E on E.id_empleados=D.id_empleados ");
              while($row=mysqli_fetch_array($consulta)){
            ?>

              <td><?php echo $row['nombres']." ".$row['apellidos']; ?> </td>
              <td><?php echo $row['telefono']; ?> </td>
              <td><?php echo "$  ".$row['deuda_total']; ?> </td>

              <td><a href="#" class="list" title="Ver Detalle de Deudas" data-toggle="modal" data-target="#modalAgregarCategoria"  data-id="<?php echo $row['id_deuda_socios'] ?>"> <button class="btn btn-default"><i class="far fa-eye" ></i></button></a> </td>

              <td>
                <a href="#" class="agg_deuda" title="Agregar Otras Deudas" data-toggle="modal" data-target="#modalAgregarUsuario"  data-id="<?php echo $row['id_deuda_socios'] ?>"> <button class="btn btn-primary"><i class="fas fa-coins"></i></button></a>
            </td>
...
$(document).ready(function(){
  ...
  var dataString ="guardar_otras_deudas.php?id="+idr;
...
$(document).ready(function(){
  ...
  $.ajax({
    url: "tabla_detalle_deuda_socios.php",
    data: dataString,
    async: false,
