  ...
  <section class="content">
    <div class="box">
      <div class="box-header with-border">
        ...
        <a href="ingreso_solicitud_servi.php"><button type="button" class="btn btn-default">Solicitar Servicio <i class="fas fa-paper-plane"></i></button></a>
      ...
      <div class="box-body cont_tabla">
         <table class="tabla" id="tabla" >
          ...
          <tbody>
              ...
              <?php
                $consulta=mysqli_query($con,"SELECT * from personas P inner join curso C on C.id_curso=P.id_curso inner join extracurricular EX on EX.id_extracurricular=P.id_extracurricular  inner join servicio S on S.id_servicio=P.id_servicio WHERE P.id_clientes='$id' ");
                while($row=mysqli_fetch_array($consulta)){
              ?>
              <tr <?php if($row['id_estado']=="2") { echo 'style="background: #d16464;"'; }?> >
                ...
                <td><div class="btn-group">
                  <a href="editar_estudiante.php?id=<?php echo $row['id_personas'] ?>" title="Editar Estudiante"> <button class="btn btn-primary"><i class="fa fa-pencil"></i></button></a>
                </div></td>
                </tr>
                <?php if($row['id_estado']=="2") { ?>
                <script type="text/javascript">
                  Swal.fire(
                      'Por favor, Solicitar el servicio!  <i class="fas fa-paper-plane"></i>',
                      'Tambien actualice la información de sus hijos!',
                      'warning'
                    )
                </script>
                <?php } ?>
...
<div id="modalAgregarUsuario" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" action="guardar_estudiante.php?id=<?php echo $id."&tp=".$tiperso; ?>" method="post" enctype="multipart/form-data">
        <!--========== CABEZA DEL MODAL =================-->
