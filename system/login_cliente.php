...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Ingresar al sistema - Clientes</p>

    <form action="login_cliente_proceso.php" method="post">
    ...
    <br>
    <div class="cont_link_bt">
      <a href="recuperar_clave.php">Olvide Contraseña</a>
