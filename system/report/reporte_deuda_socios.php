...
$consulta=mysqli_query($con,"SELECT * from deuda_socios D inner join empleados E on E.id_empleados=D.id_empleados WHERE E.id_empleados!='1' ".$query." ");
...
$pdf->SetFillColor(55, 144, 191);
 ...
 $pdf->Cell(35,10,utf8_decode('Cedula'),1,0,'C',true);
 $pdf->Cell(60,10,utf8_decode('Nombres'),1,0,'C',true);
$pdf->Cell(30,10,utf8_decode('Telefono'),1,0,'C',true);
$pdf->Cell(30,10,utf8_decode('Deuda Pendien'),1,1,'C',true);
...
$pdf->Cell(30,10,utf8_decode($row5['fecha']),1,0,'C');
$pdf->Cell(35,10,utf8_decode($row5['cedula']),1,0,'C');
$pdf->Cell(60,10,utf8_decode($row5['nombres']." ".$row5['apellidos']),1,0,'C');
$pdf->Cell(30,10,utf8_decode($row5['telefono']),1,0,'C');
$pdf->Cell(30,10,utf8_decode("$ ".$row5['deuda_total']),1,1,'C');
$total+=$row5['deuda_total'];
}
$y=$pdf->GetY();
$pdf->SetY($y+2);
$pdf->Cell(155,10,utf8_decode('DEUDA TOTAL DE SOCIOS'),1,0,'C');
