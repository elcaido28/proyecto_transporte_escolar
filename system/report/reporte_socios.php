...
$consulta=mysqli_query($con,"SELECT *,T.descrip descripcion,ES.descrip descri FROM empleados E INNER JOIN tipo_empleado T ON T.id_tipo_empleado=E.id_tipo_empleado INNER JOIN estado ES ON ES.id_estado=E.id_estado WHERE E.id_empleados!='1' and T.id_tipo_empleado='4' ".$query." OR E.id_empleados!='1' and T.id_tipo_empleado='7' ".$query." ");
