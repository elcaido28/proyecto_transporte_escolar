...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Reporte De Personas por Ruta</h1>
    <ol class="breadcrumb">
      <li><a href="inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
      <li class="active">Personas por Ruta</li>
    </ol>
  </section>
      ...
      <div class="box-header with-border">
        ...
        <div class="modal-dialog" style="border:1px solid rgb(175, 175, 175)">
          <div class="modal-content">
            <form role="form" action="report/reporte_personas_ruta.php" method="post" target="_blank" enctype="multipart/form-data">
              <!--========== CABEZA DEL MODAL =================-->
